  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-blue-900">System Users</h1>
          <p className="text-blue-700">Manage ICT Help Desk users and permissions</p>
        </div>
                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-2">
                    ...
                    {user.email === 'ellisalat@gmail.com' && (
                      <Shield className="h-5 w-5 text-yellow-500" title="Super User" />
                    )}
                  </div>
            ...
            <CardContent>
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant={getRoleColor(user.role)} className="bg-blue-100 text-blue-800">
                    {user.role}
                  </Badge>
                </div>
